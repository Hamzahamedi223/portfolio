      ...
      {selectedOption == "location" ? (
        <div>
          <label className="input input-bordered flex items-center gap-2">
            <MapPin />
            <input type="text" className="grow" onChange={(event) => onInputChange(event, "location")} placeholder="location" 
            key={1}
        ...
        <div>
          <label className="input input-bordered flex items-center gap-2">
            <Link2 />
            <input type="text" className="grow" onChange={(event) => onInputChange(event, "url")} placeholder="url" 
            key={2}
